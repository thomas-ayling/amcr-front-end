...
const Grid = ({ totalNum, currentNode, nodeArray }) => {
  const gridStyle = {
  ...
  return (
    <div className='diagram-grid-component'>
      <div className='diagram-grid-container' style={gridStyle}>
        <Empty />
        <RowOne currentNode={currentNode} nodeArray={nodeArray} />
        ...
        {totalNum > 3 ? <RowTwo totalNum={totalNum} currentNode={currentNode} nodeArray={nodeArray} /> : <Empty />}
        ...
        {totalNum > 6 ? <RowThree totalNum={totalNum} currentNode={currentNode} nodeArray={nodeArray} /> : <Empty />}
        <Empty />
      </div>
    </div>
  );
